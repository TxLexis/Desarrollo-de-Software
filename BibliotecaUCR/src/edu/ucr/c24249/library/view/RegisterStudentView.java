...
public class RegisterStudentView {
    private final RegisterStudentController controller;

    public RegisterStudentView(RegisterStudentController controller) {
    ...
    public void register() {
        ...
        RegisterStudentController.Result result = controller.register(cardId, fullName, address);
